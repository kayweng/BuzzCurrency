            ...
            <l-table :data="tableData.data">
              <template slot-scope="{row}">
                ...
                <td class="td-actions text-right">
                  <button type="button" class="btn btn-info btn-simple btn-link" v-tooltip.top-center="editTooltip">
                    <i class="fa fa-edit"></i>
                  </button>
                  <button type="button" class="btn btn-danger btn-simple btn-link" v-tooltip.top-center="deleteTooltip">
