            ...
            <fg-input label="Input groups">
              <div class="row">
                <fg-input class="col-sm-3"
                          ...
                          type="text">
                  <span slot="addonLeft" class="input-group-addon">@</span>
                </fg-input>
                <fg-input class="col-sm-3"
                          type="text">
                  <span slot="addonLeft" class="input-group-addon">.00</span>
                </fg-input>
                <fg-input class="col-sm-6"
                          type="text">
                  <span slot="addonLeft" class="input-group-addon">$</span>
                  <span slot="addonRight" class="input-group-addon">.00</span>
                </fg-input>
              </div>
            </fg-input>
